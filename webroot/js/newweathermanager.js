...
var weatherInfo = { currentCond: {
  ...
  reboot: false,
  ad: "You are watching the Weatherscan IntelliStar system. Weatherscan is a digital cable and satellite television network that is owned by a consortium owned in turn by NBCUniversal and investment firms The Blackstone Group and Bain Capital. Weatherscan features uninterrupted local weather information in graphical format on a continuous loop that is generated by an IntelliStar unit installed at the cable provider's headend; Weatherscan does not feature on-air talent of any kind."
}
